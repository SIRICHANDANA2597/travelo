...
<ul class="cb-slideshow">
            <li><span>Image 01</span><div><h3>Maldives</h3></div></li>
            <li><span>Image 02</span><div><h3>Railay Beach, Thailand</h3></div></li>
            <li><span>Image 03</span><div><h3>Mounsuni Island, India</h3></div></li>
            <li><span>Image 01</span><div><h3>Maldives</h3></div></li>
            <li><span>Image 02</span><div><h3>Railay Beach, Thailand</h3></div></li>
            <li><span>Image 03</span><div><h3>Mounsuni Island, India</h3></div></li>
        ...
        <div class="container">
		   ...
		   <a href="/Vplace">Visting Places</a>
